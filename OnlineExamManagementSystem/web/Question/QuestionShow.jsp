    ...
    <div class="layui-body">
        ...
        <table border='2'  align='center'>
            <tr style="align-content: center">
                ...
                <td>正确答案</td>
                <%
                    quanxian = (Integer)session.getAttribute("quanxian");
                    if(quanxian == 0){
                %>
                <td colspan="2">操作</td>
                <%
            ...
            <c:forEach items="${requestScope.questionList}" var="question" varStatus="vs">
                <tr>
                    ...
                    %>
                    <td>
                        <a href='<%=request.getContextPath()%>/QuestionDeleteServlet?QuestionId=${question.questionId}'>注销题目</a>
                    </td>
                    <td>
                        <a href='<%=request.getContextPath()%>/FindQuestionByIdServlet?QuestionId=${question.questionId}'>题目详情</a>
                    </td>
                    <%
                        }
                    %>
