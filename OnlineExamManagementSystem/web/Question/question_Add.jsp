...
<div class="layui-layout layui-layout-admin">
    ...
    <div class="layui-body">
        ...
        <center>
            <font style="color:red; font-size: 35px ">
                试题注册界面
            </font>
            <form action="<%=request.getContextPath()%>/QuestionAddServlet" method="get">
                <table border="2">
                    <tr>
                        <td>题目</td>
                        <td><input type="text" name="title" value="比如 以下哪部番剧不属于校园四霸"></td>
                    </tr>
                    <tr>
                        <td>A</td>
                    ...
                    <tr>
                        <td><input type="submit" value="试题注册"></td>
