    ...
    <div class="layui-body">
        ...
        <center>
            ...
            <table border='2'  align='center'>
                ...
                <tr>
                    <td>${requestScope.UserFindSelf.userId}</td>
                    <td>${requestScope.UserFindSelf.userName}</td>
                    <td>******</td>
                    <td>${requestScope.UserFindSelf.sex}</td>
                    <td>${requestScope.UserFindSelf.email}</td>
